package tstpkg2_test

import (
	"fmt"
	"testing"

	"github.com/dancsecs/gotomd/internal/gotest/testdata/tstpkg2"
...
func Test_PASS_Example2(t *testing.T) {
	...
	chk.Int(tstpkg2.TimesTwo(2), 4)
	chk.Int(tstpkg2.TimesThree(222222222), 666666666)

	structure := new(tstpkg2.StructureType)
	structure.F1 = "Total: "
...
func Test_FAIL_Example2(t *testing.T) {
	...
	chk.Int(tstpkg2.TimesTwo(2), 5, "2+2=5 (is true for big values of two)")
	chk.Str(
